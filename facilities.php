...
?> 
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <h1 class="page-header">Facilities <small>What do we have to offer?</small></h1>
          <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <h2 class="page-header">What do we have to offer</h2>
			<p>St. Julian's Centre offers a quiet and serene place to set your own pace; offering overnight accommodations, meals, and meeting places away from the hustle of the city. Near enough to Nairobi (27 km) for easy access even for day events and retreats, but in the cool green highlands of Kenya.</p>
			<p>The main house is elegant, built in the villa style with a large lounge and library, both with fireplaces, intimate and ready for meetings, conversations, resting, or reading.</p>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <ul id="myTab" class="nav nav-tabs">
            <li class="active"><a href="#service-one" data-toggle="tab">BoardRoom</a></li>
            <li><a href="#service-two" data-toggle="tab">Accomodation</a></li>
            <li><a href="#service-three" data-toggle="tab">Chapel</a></li>
            <li><a href="#service-four" data-toggle="tab">Library</a></li>
            <li><a href="#service-five" data-toggle="tab">Restaraunt</a></li>
            <li><a href="#service-six" data-toggle="tab">Nature experience</a></li>
          </ul>
          <div id="myTabContent" class="tab-content">
            ...
            <div class="tab-pane fade" id="service-two">
			  ...
			  <p>Three cottages offer secluded privacy. The "honeymoon banda" is most wonderful for anniversaries, etc. The other cottages offer a safari atmosphere. There is also a youth hostel for up to 10 young adults..</p>
            </div>
